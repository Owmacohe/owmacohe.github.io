let cards = [
    [
        ...
        '',
        'A first-person 3D mall exploration and puzzle solving game with a good dose of story and horror. Use improvised tools to solve the environmental puzzles, discover the gloomy husk of an abandoned mall, and use the dynamic lighting system to bring areas of the game back to life.',
        'Over the game\'s 6 month development, I acted as production manager, programming and puzzle implementation lead, and 3D modeller alongside my other team members. I worked using the <a href="https://github.com/StephanieRct/NiEngine">NiEngine state engine</a> to implement virtually all interactions within the game, from menu screens, to puzzles, and even for the credits. I also put the game\'s <a href="https://myfriendaki.com">website</a> together.\n\nMy Friend Aki released on <a href="https://store.steampowered.com/app/2584180/My_Friend_Aki">Steam</a> and <a href="https://duck-duck-juice.itch.io/my-friend-aki">Itch</a> on November 9th 2023, and has since surpassed 190 downloads and over 1,000 impressions. My team and I are overjoyed and are extremely thankful for everyone who wishlisted, downloaded, and played the game.',
        'my_friend_aki.png'
    ],
    [
        'UNDERSCORE',
    ...
    [
        ...
        'Descant is a Unity dialogue system plugin. It aims to hit the sweet spot between quality UI, powerful features, and easy-to-lean functionality, while also adding optional \'dialogue enhancements\' that introduce features to break away from underwhelming trends seen in many interactive fiction games. These node enhancements act similar to Unity’s standard GameObject Component system.',
        'The Unity Asset Store is chock full of many types of dialogue plugins, ranging from feature-rich, to ultra-minimalist, to downright bad. Descant\'s modular approach is so-far not explored in the world of Unity dialogue systems. The project will be free <i>(and hopefully collaborative open-source)</i> forever.',
        'descant.png'
    ],
    [
        'Something Quiet',
        'Unity 3D, C#, Blender',
        '', '',
        'https://omch.itch.io/something-quiet',
        '',
        'A meditative and single-minded experience crafted to explore feeling and atmosphere through environment, sound design, poetry, and endless repetition. Taking advantage of advanced rendering techniques and fog shaders in Unity 6 and the Universal Render Pipeline, the game is both technical and whimsical.',
        '\n\n\n\n',
        'something_quiet.png'
    ],
    [
    ...
    [
        ...
        '', '', '',
        'A tag-based wiki system is inspired by <a href="https://tiddlywiki.com">TiddlyWiki</a>. Operating purely through Javascript magic, it turns MarkDown files into hypertext articles, which can be tagged, linked to, and generated as dynamic lists. It requires no programming knowledge, save for some understanding of the system\'s modified MarkDown language (see below for more), and the ability to edit <b>.md</b> and <b>.txt</b> files.',
        '\n\n\n\n',
        'pantry.png'
    ],
    [
        ...
        '',
        'A resource-management game about culling the weak from your fanatical cult, with inspirations taken from roguelikes and rhythm games. Through story exposition, haunting graphics, and simple mechanics, the game aims to deliver visceral moments, tension, and damned-if-you-do damned-if-you-don\'t gameplay.',
        '\n\n\n\n',
        'cultus_dextra.png'
    ]
];
