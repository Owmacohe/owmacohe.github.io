var captions = [
  [
    ...
    ['report_6/bridge.jpg', 'Creature of use alternating redstone lights on the bridge by WonderAnchor\'s base'],
    ['report_6/cacophany_1.jpg', 'Step one of the cacophany machine\'s construction'],
    ...
    ['report_6/immersive_pad.jpg', 'Light spilling dow from the glass roof above my base (taken during the Immersive Space experience)'],
    ...
    ['report_6/immersive_radioactive_2.jpg', 'The same monement, this time from deep below (taken during the Immersive Space experience)'],
    ...
    ['report_6/lilypads.jpg', 'A really pretty sunset vista reflecting off water and lilypads'],
    ['report_6/seaside_village.jpg', 'A uniquely-generating structure: a seaside village'],
    ['report_6/underwater.jpg', 'Yet more underwater reflections that alaways seem to blow my mind'],
    ['report_6/waves.jpg', 'You\'d be forgiven for thinking that this isn\'t a Minecraft screenshot'],
    ['report_6/whale.jpg', 'Another magestic animal from the Alex\'s Mobs mod, which continues to impress']
  ]
];
