  ...
  for (var i = 0; i < text.length; i++) {
    if (isValid(text[i])) {
      ...
      if (i < text.length - 1 && isHModifier(text[i]) && text[i+1] == 'h') {
        ...
        path = 'images/pairs/psp_pairs_' + offset + '.png';
        ...
        switch (text[i]) {
          case 'q':
            path = 'images/alphabet/psp_alphabet_11.png';
            break;
          case 'z':
            path = 'images/alphabet/psp_alphabet_19.png';
            break;
          case ' ':
            path = 'images/space.png';
            break;
          case '.':
            path = 'images/period.png';
            break;
          case '?':
          ...
          default:
            ...
            path = 'images/alphabet/psp_alphabet_' + ascii + '.png';
            break;
        }
      }
